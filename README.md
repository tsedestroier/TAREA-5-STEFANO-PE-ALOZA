...
* **[Ejercicio 1: Sistema de Comandos por UART2](./Ejercicio-1/main.c)**
...
* **[Ejercicio 2: Multitarea con FreeRTOS](./Ejercicio-2/)**
  * *Descripción:* Creación y distribución de tareas concurrentes utilizando FreeRTOS en múltiples núcleos del ESP32.
* **[Ejercicio 3: Sistema Integrado (UART + FreeRTOS + I2C + OLED)](./Ejercicio-3/)**
  * *Descripción:* Proyecto integrador que combina la recepción de comandos por UART, control de hardware (LEDs y pulsador físico), lectura de sensores analógicos y renderizado en tiempo real de una gráfica de líneas de tiempo (*estilo osciloscopio*) en una pantalla **OLED SSD1306** por I2C.
